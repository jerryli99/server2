...
<div class="big-container">
    ...
    <div class="container" id="container">
        ...
        if(isset($_POST['submit'])){
            echo "<p>" . 
                 "My UserName : " . $_POST['this_user']  . "<br>" .
                 "My Category : " . $_POST['category']   . "<br>" .
                 "My Location : " . $_POST['location']   . "<br>" .
                 "My Text     : " . $_POST['description']. "<br>" .
                 "Exchange ID : " . $_POST['productID']  . "<br>" .
